                ...
                <v-card-text>
                    ...
                    show-expand>
                        ...
                        <template v-slot:expanded-row="{ item }">
                            <v-row>
                                <v-col>
                                    <v-list-item v-for="orderDetailResDto in item.orderDetailDtoList"
                                        :key="orderDetailResDto.productId">
                                        <v-list-item-content>
                                            <v-list-item-title>
                                                {{ orderDetailResDto.productName }} {{ orderDetailResDto.productCount }}
                                                개
                                            </v-list-item-title>
                                        </v-list-item-content>
                                    </v-list-item>
